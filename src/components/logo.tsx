...
export function Logo({ className }: { className?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="grad-globe" x1="0%" y1="50%" x2="100%" y2="50%">
          <stop offset="0%" style={{ stopColor: '#f39c12', stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: '#2ecc71', stopOpacity: 1 }} />
        </linearGradient>
      </defs>
      <g>
        <circle cx="50" cy="50" r="48" stroke="#f39c12" strokeWidth="4" fill="none" />
        <circle cx="50" cy="50" r="44" fill="#0072CE" />
        <g mask="url(#globe-mask)">
          <rect x="15" y="15" width="70" height="70" fill="url(#grad-globe)" />
        </g>
        <mask id="globe-mask">
            <path 
                fill="white"
